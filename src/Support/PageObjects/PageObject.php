...
{
    protected AbstractBrowser|Browser $browser;
    protected string $path = '';

    public function __construct(AbstractBrowser|Browser $client)
    {
        $this->browser = $client;
    }

    protected function getBrowser(): AbstractBrowser|Browser
    {
        return $this->browser;
    }
